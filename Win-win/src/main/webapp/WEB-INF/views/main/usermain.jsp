...
<div class="container">
	...
	<h4 class="text-center font-weight-bold">내담C&C는 당신의 <span style="color: #008CBA">꿈</span>과 <span style="color: #008CBA">열정</span>을 응원합니다.</h4>
...
<!-- 	</div> -->
	...
	<div class="text-center mt-5">
		...
		<a class="a" href="/faq/faq"><i class="far fa-question-circle fa-2x ml-5 mr-5 pl-4 pr-4"></i></a>
	</div>
