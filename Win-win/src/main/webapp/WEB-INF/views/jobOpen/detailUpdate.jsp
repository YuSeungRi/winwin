			...
			<c:if test="${i ne 0 }">
				<div class="detailin mt-5 p-3 bg-secondary">
					...
					<div class="form-inline m-1">
						<div class="col-2">
							<label for="sector">모집 부서</label>
						</div>
						<div class="col-6">
							<input type="text" id="sector" class="form-control w-100" name="detail[${i }].sector" placeholder="ex) SI사업부" value="${detail.sector }" required />
						</div>
						<div class="col-4">
							<c:if test="${i eq 0 }">
