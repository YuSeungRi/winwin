...
<div class="container">
	<div>
		...
		<ul class="nav justify-content-end mb-2" >	
		  ...
		  <li class="nav-item" data-toggle="collapse" data-target="#navbarToggleExternalContent" aria-controls="navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation">
		    <div class="font-weight-bold ml-3 mr-1" style="cursor: pointer">문의사항</div>
		  </li>
		</ul>
			...
			<div class="pos-f-t">
			  <div class="collapse" id="navbarToggleExternalContent">
				<ul class="nav justify-content-end mb-1">
					<li class="nav-item ml-3 font-weight-bold text-black-50" style="font-size: 13px"><a href="/notice/list" style="text-decoration: none; color: gray; padding-left: 1px">공지사항</a></li>
					<li class="nav-item ml-3 font-weight-bold text-black-50" style="font-size: 13px"><a href="/applyMenu/selectApply" style="text-decoration: none; color: gray; padding-left: 1px">입사지원</a></li>
<!-- 					<li class="nav-item ml-4 font-weight-bold text-black-50" style="font-size: 13px"><a href="/qna/list" style="text-decoration: none; color: gray; padding-left: 1px">문의사항</a></li> -->
					<li class="nav-item ml-3 font-weight-bold text-black-50" style="font-size: 13px"><a href="/faq/faq" style="text-decoration: none; color: gray;">자주묻는질문</a></li>
				</ul>
				<ul class="nav justify-content-end mb-2">
					...
					<li class="nav-item ml-3  font-weight-bold text-black-50 mr-xl-5" style="font-size: 13px"><a href="/applyMenu/passfail" style="text-decoration: none; color: gray; padding-right: 22px;">결과확인</a></li>
					<li class="mr-4"></li>
				</ul>
			  </div>	  
